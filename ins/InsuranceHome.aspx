    ...
    <nav class="navbar navbar-inverse" style="width:100%;">
        <div class="container-fluid" style="margin-left:200px; width:72%;">
            ...
            <ul class="nav navbar-nav">
                <li style="font-weight:bolder"><a href="#">CLAIM A POLICY</a></li>
                <li style="font-weight:bolder"><a href="#">DO PAYMENT</a></li>
        ...
        <div class="main">
            ...
            <div class="container">
             ...
             <div class="container2">
                    ...
                    <asp:Button ID="Button1" runat="server" Text="GO" class="btn btn-danger" />
        ...
        <nav class="navbar navbar-inverse navbar-fixed-bottom" style="width:100%;">
            <div class="container-fluid1" style="margin-left:200px; width:72%;">
                    ...
                    <ul class="nav navbar-nav" style="margin-left:200px;">
                        <li style="width:400px; font-weight:bolder"><a href="#">CUSTOMER PORTAL</a></li>
