...
<body>
    ...
    <div style="width:75%;margin-left:200px;">
        ...
        <br />
        <hr />
        <asp:Button ID="btnViewCus" runat="server" Text="View Customers" OnClick="btnViewCus_Click" /><br /><br />
        ...
        <br />
        <br />
        <h3 style="color:white;">Delete a Customer</h3>
        <asp:TextBox ID="tbCusID" runat="server" Class="form-control"></asp:TextBox>
        <asp:Button ID="btnDeleteCus" runat="server" Text="Delete Customer" OnClick="btnDeleteCus_Click" /><br />
