<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CustomerClaim.aspx.cs" Inherits="WebApplication2.CustomerClaim" %>
...
<body>
    ...
    <form id="form1" runat="server" style="border:2px solid #ccc;width:70%;margin-left:200px;">
        <div class="form-group" style="width:50%;margin-left:200px">
            ...
            <asp:TextBox ID="tbName" runat="server" class="form-control"></asp:TextBox><br />
            <asp:Label ID="lblInstitution" runat="server" Text="Institution"></asp:Label><br />
            <asp:TextBox ID="tbInstitution" runat="server" class="form-control"></asp:TextBox><br />
            <asp:Label ID="lblClaimamount" runat="server" Text="Claimamount"></asp:Label><br />
            <asp:TextBox ID="tbClaimamount" runat="server" class="form-control"></asp:TextBox><br />
            <asp:Label ID="lblPaidamount" runat="server" Text="Paidamount"></asp:Label><br />
            <asp:TextBox ID="tbPaidamount" runat="server" class="form-control"></asp:TextBox><br />
            <asp:Label ID="lblClaimtype" runat="server" Text="Claimtype"></asp:Label><br />
    ...
    <nav class="navbar navbar-inverse navbar-fixed-bottom" style="width:100%;">
            <div class="container-fluid1" style="margin-left:200px; width:72%;">
                    ...
                    <ul class="nav navbar-nav" style="margin-left:200px;">
                        ...
                        <li style="width:400px;font-weight:bolder"><a href="#">AGENT PORTAL</a></li>
                    </ul>
           </div>
        </nav>
</body>
